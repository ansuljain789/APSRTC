...
import Map from '../../components/(live tracker)/Map';
import SearchBar from '../../components/(live tracker)/SearchBar';
import BusList from '../../components/(live tracker)/BusLIst';
import DestinationForm from '../../components/(live tracker)/DestinationForm'; // If you want manual rerouting here
